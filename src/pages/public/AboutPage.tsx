  ...
  return (
    <div>
            ...
            <div className="relative">
              ...
              <div className="space-y-8">
                {content.milestones.map((m, i) => (
                  <AnimatedSection key={m.year} delay={STAGGER_DELAYS[i % 5]}>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {content.coreValues.map((value, i) => {
              ...
              return (
                <AnimatedSection key={value.title} delay={STAGGER_DELAYS[i % 5]}>
                  <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 hover:translate-y-[-4px] border border-border">
      ...
      <section className="py-20 sm:py-24 px-4 bg-bg-gray">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-8">
            {content.threePromises.map((promise, i) => {
              const PromiseIcon = getIcon(promise.iconName)
              return (
                <AnimatedSection key={promise.title} delay={STAGGER_DELAYS[i % 5]}>
                  <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 hover:translate-y-[-4px]">
        ...
        <div className="max-w-4xl mx-auto">
          <AnimatedSection variant="scale">
            <div className="relative bg-gradient-to-br from-navy/5 to-navy/10 rounded-2xl p-10 sm:p-14">
              <div className="absolute top-6 left-8 text-6xl font-serif text-gold/30 leading-none">&ldquo;</div>
              ...
              <div className="absolute bottom-6 right-8 text-6xl font-serif text-gold/30 leading-none rotate-180">&ldquo;</div>
            </div>
          </AnimatedSection>
        </div>
      </section>
      ...
      <CTASection
        variant="navy-bg"
        title="期待与您携手合作"
        subtitle="了解更多关于我们的业务和服务"
        primaryAction={{ label: '业务范围', href: ROUTES.SERVICES }}
        secondaryAction={{ label: '联系我们', href: ROUTES.CONTACT }}
      />
    </div>
  )
}
